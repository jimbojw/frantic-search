...
- 2026-03-18: ListsPage is lazy-loaded via `lazy(() => import('./ListsPage'))` with Suspense to reduce the main bundle (~42 KB). The chunk loads on demand when the user navigates to the list view.
