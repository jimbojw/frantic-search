...
| `shared/src/search/eval-printing.ts` | Before **rarity** / **game** / **frame** / **in** / **legal** / **banned** / **restricted** lookup: resolve; use resolved value. **`set`** / **`set_type`** use operator-selected prefix or exact on precomputed normalized row strings (no `resolveForField` in the leaf; Specs 047 / 179). |
