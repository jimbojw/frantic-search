...
const REFERENCE_ENTRIES: DocEntry[] = [
  ...
  { id: 'mana-value', docParam: 'reference/fields/face/mana-value', title: 'mana value', quadrant: 'reference', prev: 'reference/fields/face/mana', next: 'reference/fields/face/my' },
