...
/** Question mark in circle — syntax help. */
export function IconQuestionMarkCircle(props: { class?: string }) {
  return (
    <svg {...SVG_PROPS} class={props.class ?? 'size-4'} aria-hidden>
      <path
        stroke-linecap="round"
...
/** Open book — documentation hub. */
export function IconBookOpen(props: { class?: string }) {
  return (
    <svg {...SVG_PROPS} class={props.class ?? 'size-4'} aria-hidden>
      <path
        stroke-linecap="round"
...
/** Arrow-right-on-rectangle (Heroicons). Conveys "go to" / navigate. */
export function IconArrowRightOnRectangle(props: { class?: string }) {
  return (
    <svg {...SVG_PROPS} stroke-width="1.5" class={props.class ?? 'size-4'} aria-hidden>
      <path
        stroke-linecap="round"
        stroke-linejoin="round"
