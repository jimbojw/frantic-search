...
export { isKnownColorValue, getColorAlternatives, isTriggerField, isFormatOrIsValue, getFormatOrIsAlternatives, COLOR_TRIGGER_FIELDS, FORMAT_IS_TRIGGER_FIELDS } from "./wrong-field-utils";
export type { ColorAlternative, FormatOrIsAlternative } from "./wrong-field-utils";
